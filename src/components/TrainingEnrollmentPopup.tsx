...
interface TrainingEnrollmentPopupProps {
  isOpen: boolean;
  onClose: () => void;
...
export const TrainingEnrollmentPopup = ({ isOpen, onClose, selectedTraining = "" }: TrainingEnrollmentPopupProps) => {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-border">
                <div>
                  <h2 className="text-2xl font-bold text-foreground">Teacher Training Enrollment</h2>
                  <p className="text-muted-foreground mt-1">Start your teaching career journey today</p>
                </div>
                <button
                  onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Tell us about your requirements, your teaching background, preferred timings..."
                    rows={5}
